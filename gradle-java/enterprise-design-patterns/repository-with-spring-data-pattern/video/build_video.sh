#!/usr/bin/env bash
#
# Builds the Repository with Spring Data pattern teaching video.
#
...
#
# Outputs:
#   repository-with-spring-data-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   repository-with-spring-data-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=repository-with-spring-data-pattern-explained.mp4
OUT_AUDIO=repository-with-spring-data-pattern-explained.m4a
OUT_SUBS=repository-with-spring-data-pattern-explained.srt
