#!/usr/bin/env bash
#
# Builds the Identity Map with JPA pattern teaching video.
#
...
#
# Outputs:
#   identity-map-with-jpa-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   identity-map-with-jpa-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=identity-map-with-jpa-pattern-explained.mp4
OUT_AUDIO=identity-map-with-jpa-pattern-explained.m4a
OUT_SUBS=identity-map-with-jpa-pattern-explained.srt
