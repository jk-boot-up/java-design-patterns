#!/usr/bin/env bash
#
# Builds the Front Controller pattern teaching video.
#
...
#
# Outputs:
#   front-controller-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   front-controller-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=front-controller-pattern-explained.mp4
OUT_AUDIO=front-controller-pattern-explained.m4a
OUT_SUBS=front-controller-pattern-explained.srt
