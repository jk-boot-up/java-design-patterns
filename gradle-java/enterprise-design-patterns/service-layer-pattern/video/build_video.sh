#!/usr/bin/env bash
#
# Builds the Service Layer pattern teaching video.
#
...
#
# Outputs:
#   service-layer-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   service-layer-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=service-layer-pattern-explained.mp4
OUT_AUDIO=service-layer-pattern-explained.m4a
OUT_SUBS=service-layer-pattern-explained.srt
