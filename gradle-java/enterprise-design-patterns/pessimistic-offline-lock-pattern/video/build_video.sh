#!/usr/bin/env bash
#
# Builds the Pessimistic Offline Lock pattern teaching video.
#
...
#
# Outputs:
#   pessimistic-offline-lock-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   pessimistic-offline-lock-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=pessimistic-offline-lock-pattern-explained.mp4
OUT_AUDIO=pessimistic-offline-lock-pattern-explained.m4a
OUT_SUBS=pessimistic-offline-lock-pattern-explained.srt
