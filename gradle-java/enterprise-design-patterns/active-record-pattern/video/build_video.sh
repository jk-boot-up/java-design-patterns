#!/usr/bin/env bash
#
# Builds the Active Record pattern teaching video.
#
...
#
# Outputs:
#   active-record-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   active-record-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=active-record-pattern-explained.mp4
OUT_AUDIO=active-record-pattern-explained.m4a
OUT_SUBS=active-record-pattern-explained.srt
