#!/usr/bin/env python3
"""Render one 1920x1080 PNG slide per scene for the Active Record video."""
...
def footer(d, label):
    ...
    d.text((W - 70, H - 58), "Active Record  ·  Java 21",
...
def kind_poster(scene, img, d):
    ...
    fitted("ACTIVE RECORD", 152, TEXT)
    fitted("THE OBJECT SAVES ITSELF", 288, ACCENT)
    ...
    # One class, and its bills -- real lines from the project.
    pill(d, 150, 556, 700, 170, RED, "5 orders checked",
         "5 hidden table operations", tag="HIDDEN QUERIES")
    pill(d, 1070, 556, 700, 170, GREEN, "new, save, find",
         "three lines", tag="QUICK TO WRITE")
    ...
    d.text((W // 2, 744), "A row that saves itself.",
           font=f(SANS_B, 44), fill=TEXT, anchor="ma")
    d.text((W // 2, 796), "The class is the table.",
