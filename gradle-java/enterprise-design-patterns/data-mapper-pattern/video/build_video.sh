#!/usr/bin/env bash
#
# Builds the Data Mapper pattern teaching video.
#
...
#
# Outputs:
#   data-mapper-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   data-mapper-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=data-mapper-pattern-explained.mp4
OUT_AUDIO=data-mapper-pattern-explained.m4a
OUT_SUBS=data-mapper-pattern-explained.srt
