#!/usr/bin/env bash
#
# Builds the Identity Map pattern teaching video.
#
...
#
# Outputs:
#   identity-map-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   identity-map-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=identity-map-pattern-explained.mp4
OUT_AUDIO=identity-map-pattern-explained.m4a
OUT_SUBS=identity-map-pattern-explained.srt
