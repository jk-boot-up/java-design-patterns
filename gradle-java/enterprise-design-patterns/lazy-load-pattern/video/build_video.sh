#!/usr/bin/env bash
#
# Builds the Lazy Load pattern teaching video.
#
...
#
# Outputs:
#   lazy-load-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   lazy-load-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=lazy-load-pattern-explained.mp4
OUT_AUDIO=lazy-load-pattern-explained.m4a
OUT_SUBS=lazy-load-pattern-explained.srt
