#!/usr/bin/env bash
#
# Builds the Unit of Work with Spring pattern teaching video.
#
...
#
# Outputs:
#   unit-of-work-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   unit-of-work-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=unit-of-work-with-spring-pattern-explained.mp4
OUT_AUDIO=unit-of-work-with-spring-pattern-explained.m4a
OUT_SUBS=unit-of-work-with-spring-pattern-explained.srt
