#!/usr/bin/env bash
#
# Builds the Transaction Script pattern teaching video.
#
...
#
# Outputs:
#   transaction-script-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   transaction-script-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=transaction-script-pattern-explained.mp4
OUT_AUDIO=transaction-script-pattern-explained.m4a
OUT_SUBS=transaction-script-pattern-explained.srt
