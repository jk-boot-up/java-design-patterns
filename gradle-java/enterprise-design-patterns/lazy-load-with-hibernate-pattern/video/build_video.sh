#!/usr/bin/env bash
#
# Builds the Lazy Load with Hibernate pattern teaching video.
#
...
#
# Outputs:
#   lazy-load-with-hibernate-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   lazy-load-with-hibernate-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=lazy-load-with-hibernate-pattern-explained.mp4
OUT_AUDIO=lazy-load-with-hibernate-pattern-explained.m4a
OUT_SUBS=lazy-load-with-hibernate-pattern-explained.srt
