#!/usr/bin/env bash
#
# Builds the Repository pattern teaching video.
#
...
#
# Outputs:
#   repository-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   repository-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=repository-pattern-explained.mp4
OUT_AUDIO=repository-pattern-explained.m4a
OUT_SUBS=repository-pattern-explained.srt
