#!/usr/bin/env bash
#
# Builds the Unit of Work pattern teaching video.
#
...
#
# Outputs:
#   unit-of-work-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   unit-of-work-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=unit-of-work-pattern-explained.mp4
OUT_AUDIO=unit-of-work-pattern-explained.m4a
OUT_SUBS=unit-of-work-pattern-explained.srt
