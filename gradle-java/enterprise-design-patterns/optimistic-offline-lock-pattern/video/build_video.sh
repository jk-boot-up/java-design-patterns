#!/usr/bin/env bash
#
# Builds the Optimistic Offline Lock pattern teaching video.
#
...
#
# Outputs:
#   optimistic-offline-lock-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   optimistic-offline-lock-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=optimistic-offline-lock-pattern-explained.mp4
OUT_AUDIO=optimistic-offline-lock-pattern-explained.m4a
OUT_SUBS=optimistic-offline-lock-pattern-explained.srt
