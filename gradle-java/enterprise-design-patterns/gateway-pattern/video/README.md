# Gateway Pattern — Teaching Video

A narrated, slide-based video that teaches Gateway, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `gateway-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `gateway-pattern-explained.m4a` | Audio-only version. |
| `gateway-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Gateway | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force gateway`, then
...
Upload `gateway-pattern-explained.mp4`, with
