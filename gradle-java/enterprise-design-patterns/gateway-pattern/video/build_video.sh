#!/usr/bin/env bash
#
# Builds the Gateway pattern teaching video.
#
...
#
# Outputs:
#   gateway-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   gateway-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=gateway-pattern-explained.mp4
OUT_AUDIO=gateway-pattern-explained.m4a
OUT_SUBS=gateway-pattern-explained.srt
