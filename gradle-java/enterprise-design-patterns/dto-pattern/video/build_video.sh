#!/usr/bin/env bash
#
# Builds the DTO pattern teaching video.
#
...
#
# Outputs:
#   dto-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   dto-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=dto-pattern-explained.mp4
OUT_AUDIO=dto-pattern-explained.m4a
OUT_SUBS=dto-pattern-explained.srt
