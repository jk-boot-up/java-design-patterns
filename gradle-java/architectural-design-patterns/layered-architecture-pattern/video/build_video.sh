#!/usr/bin/env bash
#
# Builds the Layered Architecture pattern teaching video.
#
...
#
# Outputs:
#   layered-architecture-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   layered-architecture-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=layered-architecture-pattern-explained.mp4
OUT_AUDIO=layered-architecture-pattern-explained.m4a
OUT_SUBS=layered-architecture-pattern-explained.srt
