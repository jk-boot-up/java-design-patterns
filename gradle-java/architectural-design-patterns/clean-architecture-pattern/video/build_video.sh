#!/usr/bin/env bash
#
# Builds the Clean Architecture pattern teaching video.
#
...
#
# Outputs:
#   clean-architecture-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   clean-architecture-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=clean-architecture-pattern-explained.mp4
OUT_AUDIO=clean-architecture-pattern-explained.m4a
OUT_SUBS=clean-architecture-pattern-explained.srt
