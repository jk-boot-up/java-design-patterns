#!/usr/bin/env bash
#
# Builds the Clean Architecture with Spring pattern teaching video.
#
...
#
# Outputs:
#   clean-architecture-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   clean-architecture-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=clean-architecture-with-spring-pattern-explained.mp4
OUT_AUDIO=clean-architecture-with-spring-pattern-explained.m4a
OUT_SUBS=clean-architecture-with-spring-pattern-explained.srt
