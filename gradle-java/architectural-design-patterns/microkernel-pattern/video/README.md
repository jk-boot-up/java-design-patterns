# Microkernel Pattern — Teaching Video

A narrated, slide-based video that teaches Microkernel, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `microkernel-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `microkernel-pattern-explained.m4a` | Audio-only version. |
| `microkernel-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Microkernel | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force microkernel`, then
...
Upload `microkernel-pattern-explained.mp4`, with
