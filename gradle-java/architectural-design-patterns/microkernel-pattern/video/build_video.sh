#!/usr/bin/env bash
#
# Builds the Microkernel pattern teaching video.
#
...
#
# Outputs:
#   microkernel-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   microkernel-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=microkernel-pattern-explained.mp4
OUT_AUDIO=microkernel-pattern-explained.m4a
OUT_SUBS=microkernel-pattern-explained.srt
