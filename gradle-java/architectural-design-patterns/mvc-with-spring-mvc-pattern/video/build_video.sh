#!/usr/bin/env bash
#
# Builds the MVC with Spring MVC pattern teaching video.
#
...
#
# Outputs:
#   mvc-with-spring-mvc-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   mvc-with-spring-mvc-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=mvc-with-spring-mvc-pattern-explained.mp4
OUT_AUDIO=mvc-with-spring-mvc-pattern-explained.m4a
OUT_SUBS=mvc-with-spring-mvc-pattern-explained.srt
