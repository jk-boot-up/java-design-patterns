#!/usr/bin/env bash
#
# Builds the MVC pattern teaching video.
#
...
#
# Outputs:
#   mvc-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   mvc-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=mvc-pattern-explained.mp4
OUT_AUDIO=mvc-pattern-explained.m4a
OUT_SUBS=mvc-pattern-explained.srt
