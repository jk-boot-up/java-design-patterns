#!/usr/bin/env bash
#
# Builds the Layered Architecture with Spring Boot pattern teaching video.
#
...
#
# Outputs:
#   layered-architecture-with-spring-boot-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   layered-architecture-with-spring-boot-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=layered-architecture-with-spring-boot-pattern-explained.mp4
OUT_AUDIO=layered-architecture-with-spring-boot-pattern-explained.m4a
OUT_SUBS=layered-architecture-with-spring-boot-pattern-explained.srt
