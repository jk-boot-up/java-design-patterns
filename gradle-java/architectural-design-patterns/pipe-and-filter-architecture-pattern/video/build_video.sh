#!/usr/bin/env bash
#
# Builds the Pipe and Filter Architecture pattern teaching video.
#
...
#
# Outputs:
#   pipe-and-filter-architecture-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   pipe-and-filter-architecture-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=pipe-and-filter-architecture-pattern-explained.mp4
OUT_AUDIO=pipe-and-filter-architecture-pattern-explained.m4a
OUT_SUBS=pipe-and-filter-architecture-pattern-explained.srt
