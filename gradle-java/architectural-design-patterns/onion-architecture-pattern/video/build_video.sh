#!/usr/bin/env bash
#
# Builds the Onion Architecture pattern teaching video.
#
...
#
# Outputs:
#   onion-architecture-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   onion-architecture-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=onion-architecture-pattern-explained.mp4
OUT_AUDIO=onion-architecture-pattern-explained.m4a
OUT_SUBS=onion-architecture-pattern-explained.srt
