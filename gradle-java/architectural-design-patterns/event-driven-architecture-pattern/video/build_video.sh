#!/usr/bin/env bash
#
# Builds the Event-Driven Architecture pattern teaching video.
#
...
#
# Outputs:
#   event-driven-architecture-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   event-driven-architecture-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=event-driven-architecture-pattern-explained.mp4
OUT_AUDIO=event-driven-architecture-pattern-explained.m4a
OUT_SUBS=event-driven-architecture-pattern-explained.srt
