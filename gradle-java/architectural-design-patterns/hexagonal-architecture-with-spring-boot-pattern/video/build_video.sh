#!/usr/bin/env bash
#
# Builds the Hexagonal Architecture with Spring Boot pattern teaching video.
#
...
#
# Outputs:
#   hexagonal-architecture-with-spring-boot-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   hexagonal-architecture-with-spring-boot-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=hexagonal-architecture-with-spring-boot-pattern-explained.mp4
OUT_AUDIO=hexagonal-architecture-with-spring-boot-pattern-explained.m4a
OUT_SUBS=hexagonal-architecture-with-spring-boot-pattern-explained.srt
