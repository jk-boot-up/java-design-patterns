# Hexagonal Architecture with Spring Boot Pattern — Project Specification
...
[`hexagonal-architecture-with-spring-boot-pattern-explained.md`](hexagonal-architecture-with-spring-boot-pattern-explained.md); the problem it
...
2 production classes under `com.jk.explore.hexagonalspring`:
...
1. **The core is asserted to be a plain class,** not a proxy.
2. **The rule is asserted to fail only on the shortcut.**
3. **Both storage adapters are asserted to give the same receipt.**
...
- `./gradlew build` passes. 9 test methods across `DemoRunsTest`, `HexagonalTest`.
...
| `hexagonal-architecture-with-spring-boot-pattern-explained.md` | The pattern, the code, pitfalls, comparisons |
...
The finished video is `video/hexagonal-architecture-with-spring-boot-pattern-explained.mp4`, with an
...
1. **What the video is** — "This video explains the Hexagonal Architecture with Spring Boot pattern in
...
| Runtime | ~4:36 over 16 scenes, 67 subtitle cues |  |
...
> `python3 ../../docs/make_youtube_docs.py hexagonal-architecture-with-spring-boot`. They are the one part of
...
```bash
python3 ../../docs/make_youtube_docs.py hexagonal-architecture-with-spring-boot
python3 ../../docs/make_specs.py hexagonal-architecture-with-spring-boot
```
