#!/usr/bin/env bash
#
# Builds the MVP and MVVM pattern teaching video.
#
...
#
# Outputs:
#   mvp-and-mvvm-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   mvp-and-mvvm-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=mvp-and-mvvm-pattern-explained.mp4
OUT_AUDIO=mvp-and-mvvm-pattern-explained.m4a
OUT_SUBS=mvp-and-mvvm-pattern-explained.srt
