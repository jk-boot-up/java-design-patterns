# MVP and MVVM Pattern — Teaching Video

A narrated, slide-based video that teaches MVP and MVVM, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `mvp-and-mvvm-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `mvp-and-mvvm-pattern-explained.m4a` | Audio-only version. |
| `mvp-and-mvvm-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | MVP and MVVM | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force mvp-and-mvvm`, then
...
Upload `mvp-and-mvvm-pattern-explained.mp4`, with
