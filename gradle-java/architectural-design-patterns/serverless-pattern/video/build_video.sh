#!/usr/bin/env bash
#
# Builds the Serverless pattern teaching video.
#
...
#
# Outputs:
#   serverless-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   serverless-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=serverless-pattern-explained.mp4
OUT_AUDIO=serverless-pattern-explained.m4a
OUT_SUBS=serverless-pattern-explained.srt
