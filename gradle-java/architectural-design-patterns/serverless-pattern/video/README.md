# Serverless Pattern — Teaching Video

A narrated, slide-based video that teaches Serverless, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `serverless-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `serverless-pattern-explained.m4a` | Audio-only version. |
| `serverless-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Serverless | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force serverless`, then
...
Upload `serverless-pattern-explained.mp4`, with
