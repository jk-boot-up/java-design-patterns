#!/usr/bin/env bash
#
# Builds the Hexagonal Architecture pattern teaching video.
#
...
#
# Outputs:
#   hexagonal-architecture-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   hexagonal-architecture-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=hexagonal-architecture-pattern-explained.mp4
OUT_AUDIO=hexagonal-architecture-pattern-explained.m4a
OUT_SUBS=hexagonal-architecture-pattern-explained.srt
