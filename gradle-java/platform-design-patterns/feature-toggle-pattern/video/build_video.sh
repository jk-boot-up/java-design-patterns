#!/usr/bin/env bash
#
# Builds the Feature Toggle pattern teaching video.
#
...
#
# Outputs:
#   feature-toggle-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   feature-toggle-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=feature-toggle-pattern-explained.mp4
OUT_AUDIO=feature-toggle-pattern-explained.m4a
OUT_SUBS=feature-toggle-pattern-explained.srt
