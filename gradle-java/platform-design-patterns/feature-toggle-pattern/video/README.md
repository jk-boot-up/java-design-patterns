# Feature Toggle Pattern — Teaching Video

A narrated, slide-based video that teaches Feature Toggle, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `feature-toggle-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `feature-toggle-pattern-explained.m4a` | Audio-only version. |
| `feature-toggle-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Feature Toggle | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force feature-toggle`, then
...
Upload `feature-toggle-pattern-explained.mp4`, with
