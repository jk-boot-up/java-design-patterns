#!/usr/bin/env bash
#
# Builds the Service Mesh pattern teaching video.
#
...
#
# Outputs:
#   service-mesh-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   service-mesh-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=service-mesh-pattern-explained.mp4
OUT_AUDIO=service-mesh-pattern-explained.m4a
OUT_SUBS=service-mesh-pattern-explained.srt
