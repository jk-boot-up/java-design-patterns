# Service Mesh Pattern — Teaching Video

A narrated, slide-based video that teaches Service Mesh, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `service-mesh-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `service-mesh-pattern-explained.m4a` | Audio-only version. |
| `service-mesh-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Service Mesh | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force service-mesh`, then
...
Upload `service-mesh-pattern-explained.mp4`, with
