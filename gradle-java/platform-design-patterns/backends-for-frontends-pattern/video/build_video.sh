#!/usr/bin/env bash
#
# Builds the Backends for Frontends pattern teaching video.
#
...
#
# Outputs:
#   backends-for-frontends-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   backends-for-frontends-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=backends-for-frontends-pattern-explained.mp4
OUT_AUDIO=backends-for-frontends-pattern-explained.m4a
OUT_SUBS=backends-for-frontends-pattern-explained.srt
