#!/usr/bin/env python3
"""Generate an SRT subtitle file for the Backends for Frontends video.
...
def main():
    ...
    out_path = sys.argv[2] if len(sys.argv) > 2 else "backends-for-frontends-pattern-explained.srt"
