#!/usr/bin/env bash
#
# Builds the Consumer-Driven Contract pattern teaching video.
#
...
#
# Outputs:
#   consumer-driven-contract-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   consumer-driven-contract-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=consumer-driven-contract-pattern-explained.mp4
OUT_AUDIO=consumer-driven-contract-pattern-explained.m4a
OUT_SUBS=consumer-driven-contract-pattern-explained.srt
