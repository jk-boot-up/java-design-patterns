#!/usr/bin/env bash
#
# Builds the Strangler Fig pattern teaching video.
#
...
#
# Outputs:
#   strangler-fig-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   strangler-fig-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=strangler-fig-pattern-explained.mp4
OUT_AUDIO=strangler-fig-pattern-explained.m4a
OUT_SUBS=strangler-fig-pattern-explained.srt
