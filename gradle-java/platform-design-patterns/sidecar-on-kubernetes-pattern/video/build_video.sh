#!/usr/bin/env bash
#
# Builds the Sidecar on Kubernetes pattern teaching video.
#
...
#
# Outputs:
#   sidecar-on-kubernetes-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   sidecar-on-kubernetes-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=sidecar-on-kubernetes-pattern-explained.mp4
OUT_AUDIO=sidecar-on-kubernetes-pattern-explained.m4a
OUT_SUBS=sidecar-on-kubernetes-pattern-explained.srt
