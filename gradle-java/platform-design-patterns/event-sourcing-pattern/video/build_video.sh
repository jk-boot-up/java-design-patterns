#!/usr/bin/env bash
#
# Builds the Event Sourcing pattern teaching video.
#
...
#
# Outputs:
#   event-sourcing-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   event-sourcing-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=event-sourcing-pattern-explained.mp4
OUT_AUDIO=event-sourcing-pattern-explained.m4a
OUT_SUBS=event-sourcing-pattern-explained.srt
