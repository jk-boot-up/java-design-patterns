#!/usr/bin/env bash
#
# Builds the Sidecar pattern teaching video.
#
...
#
# Outputs:
#   sidecar-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   sidecar-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=sidecar-pattern-explained.mp4
OUT_AUDIO=sidecar-pattern-explained.m4a
OUT_SUBS=sidecar-pattern-explained.srt
