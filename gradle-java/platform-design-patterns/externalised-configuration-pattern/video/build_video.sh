#!/usr/bin/env bash
#
# Builds the Externalised Configuration pattern teaching video.
#
...
#
# Outputs:
#   externalised-configuration-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   externalised-configuration-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=externalised-configuration-pattern-explained.mp4
OUT_AUDIO=externalised-configuration-pattern-explained.m4a
OUT_SUBS=externalised-configuration-pattern-explained.srt
