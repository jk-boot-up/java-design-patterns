#!/usr/bin/env bash
#
# Builds the Sidecar-with-a-Java-proxy teaching video.
#
...
#
# Outputs:
#   sidecar-java-proxy-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   sidecar-java-proxy-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=sidecar-java-proxy-pattern-explained.mp4
OUT_AUDIO=sidecar-java-proxy-pattern-explained.m4a
OUT_SUBS=sidecar-java-proxy-pattern-explained.srt
