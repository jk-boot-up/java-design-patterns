#!/usr/bin/env bash
#
# Builds the Blue-Green and Canary pattern teaching video.
#
...
#
# Outputs:
#   blue-green-and-canary-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   blue-green-and-canary-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=blue-green-and-canary-pattern-explained.mp4
OUT_AUDIO=blue-green-and-canary-pattern-explained.m4a
OUT_SUBS=blue-green-and-canary-pattern-explained.srt
