#!/usr/bin/env bash
#
# Builds the Distributed Tracing pattern teaching video.
#
...
#
# Outputs:
#   distributed-tracing-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   distributed-tracing-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=distributed-tracing-pattern-explained.mp4
OUT_AUDIO=distributed-tracing-pattern-explained.m4a
OUT_SUBS=distributed-tracing-pattern-explained.srt
