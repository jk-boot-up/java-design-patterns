#!/usr/bin/env bash
#
# Builds the Composite pattern teaching video.
#
...
#
# Outputs:
#   composite-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   composite-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=composite-pattern-explained.mp4
OUT_AUDIO=composite-pattern-explained.m4a
OUT_SUBS=composite-pattern-explained.srt
