#!/usr/bin/env bash
#
# Builds the Bridge pattern teaching video.
#
...
#
# Outputs:
#   bridge-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   bridge-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=bridge-pattern-explained.mp4
OUT_AUDIO=bridge-pattern-explained.m4a
OUT_SUBS=bridge-pattern-explained.srt
