#!/usr/bin/env bash
#
# Builds the Adapter pattern teaching video.
#
...
#
# Outputs:
#   adapter-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   adapter-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=adapter-pattern-explained.mp4
OUT_AUDIO=adapter-pattern-explained.m4a
OUT_SUBS=adapter-pattern-explained.srt
