#!/usr/bin/env bash
#
# Builds the Flyweight pattern teaching video.
#
...
#
# Outputs:
#   flyweight-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   flyweight-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=flyweight-pattern-explained.mp4
OUT_AUDIO=flyweight-pattern-explained.m4a
OUT_SUBS=flyweight-pattern-explained.srt
