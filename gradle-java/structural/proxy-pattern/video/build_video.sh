#!/usr/bin/env bash
#
# Builds the Proxy pattern teaching video.
#
...
#
# Outputs:
#   proxy-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   proxy-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=proxy-pattern-explained.mp4
OUT_AUDIO=proxy-pattern-explained.m4a
OUT_SUBS=proxy-pattern-explained.srt
