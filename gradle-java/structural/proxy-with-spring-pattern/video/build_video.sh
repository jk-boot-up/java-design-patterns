#!/usr/bin/env bash
#
# Builds the Proxy with Spring pattern teaching video.
#
...
#
# Outputs:
#   proxy-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   proxy-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=proxy-with-spring-pattern-explained.mp4
OUT_AUDIO=proxy-with-spring-pattern-explained.m4a
OUT_SUBS=proxy-with-spring-pattern-explained.srt
