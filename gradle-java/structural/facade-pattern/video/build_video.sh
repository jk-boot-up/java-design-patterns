#!/usr/bin/env bash
#
# Builds the Facade pattern teaching video.
#
...
#
# Outputs:
#   facade-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   facade-pattern-explained.m4a   audio-only version (podcast / revision)
#
...
OUT_VIDEO=facade-pattern-explained.mp4
OUT_AUDIO=facade-pattern-explained.m4a
OUT_SUBS=facade-pattern-explained.srt
