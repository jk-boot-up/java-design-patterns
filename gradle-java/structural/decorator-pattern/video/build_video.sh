#!/usr/bin/env bash
#
# Builds the Decorator pattern teaching video.
#
...
#
# Outputs:
#   decorator-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   decorator-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=decorator-pattern-explained.mp4
OUT_AUDIO=decorator-pattern-explained.m4a
OUT_SUBS=decorator-pattern-explained.srt
