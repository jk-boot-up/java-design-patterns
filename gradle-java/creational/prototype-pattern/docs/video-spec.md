...
| File | Format | Purpose |
| --- | --- | --- |
| `prototype-pattern-explained.mp4` | 1920×1080, H.264 High, 30 fps, yuv420p, AAC-LC 192 kbps stereo @ 48 kHz, `+faststart` | The video. Uploaded to YouTube as-is. |
| `prototype-pattern-explained.m4a` | AAC 192 kbps stereo | Audio-only, for revision on the move. |
| `prototype-pattern-explained.srt` | SubRip | Captions. Uploaded alongside the video. |
...
`Prototype Pattern  ·  Java 21`, and the identifiers the syntax-colouring
rules in `make_slides.py` look for (`ProductListing`, `Prototype`,
`ListingRegistry`, `ShippingProfile` in place of `PurchaseOrder`, `Builder`).
...
of the original spec apply, with `prototype-pattern-explained.mp4` /
...
| # | Kind | Scene |
| --- | --- | --- |
| 1 | poster | Prototype Pattern |
| 2 | bullets | The Job |
| 3 | code | The Repeated Eleven-Argument Call |
| 4 | code | The `Cloneable` Trap |
| 5 | bullets | Why That Hurts |
| 6 | quote | The Prototype Pattern |
| 7 | bullets | A Photocopier, Not a Blueprint |
| 8 | diagram | The Shape of It |
| 9 | code | One Method, No Baggage |
| 10 | code | `copy()` Reuses the Constructor |
| 11 | code | Deep Copy vs. Shared Reference |
| 12 | code | Cloning and Tweaking |
| 13 | code | The Registry |
| 14 | console | Running It |
| 15 | bullets | Where It Stops |
| 16 | bullets | How It Relates to the Others |
| 17 | title | One Sentence to Keep |
| 18 | outro | Thanks for Watching |
