#!/usr/bin/env bash
#
# Builds the Prototype pattern teaching video.
#
...
#
# Outputs:
#   prototype-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   prototype-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=prototype-pattern-explained.mp4
OUT_AUDIO=prototype-pattern-explained.m4a
OUT_SUBS=prototype-pattern-explained.srt
