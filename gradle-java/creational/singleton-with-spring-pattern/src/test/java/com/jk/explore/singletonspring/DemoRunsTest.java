...
class DemoRunsTest {
    ...
    void allSixActsRun() throws Exception {
        ...
        try {
            ...
            ShopApplication.main(new String[0]);
        } finally {
        ...
        assertTrue(out.contains("the same order number went to two customers: true"), out);
        assertTrue(out.contains("10000 distinct"), out);
    }
}
