#!/usr/bin/env bash
#
# Builds the Singleton with Spring pattern teaching video.
#
...
#
# Outputs:
#   singleton-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   singleton-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=singleton-with-spring-pattern-explained.mp4
OUT_AUDIO=singleton-with-spring-pattern-explained.m4a
OUT_SUBS=singleton-with-spring-pattern-explained.srt
