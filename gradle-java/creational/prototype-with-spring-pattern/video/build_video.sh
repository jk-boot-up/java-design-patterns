#!/usr/bin/env bash
#
# Builds the Prototype with Spring pattern teaching video.
#
...
#
# Outputs:
#   prototype-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   prototype-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=prototype-with-spring-pattern-explained.mp4
OUT_AUDIO=prototype-with-spring-pattern-explained.m4a
OUT_SUBS=prototype-with-spring-pattern-explained.srt
