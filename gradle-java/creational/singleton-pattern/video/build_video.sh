#!/usr/bin/env bash
#
# Builds the Singleton pattern teaching video.
#
...
#
# Outputs:
#   singleton-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   singleton-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=singleton-pattern-explained.mp4
OUT_AUDIO=singleton-pattern-explained.m4a
OUT_SUBS=singleton-pattern-explained.srt
