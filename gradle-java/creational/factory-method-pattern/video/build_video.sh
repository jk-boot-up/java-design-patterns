#!/usr/bin/env bash
#
# Builds the Factory Method pattern teaching video.
#
...
#
# Outputs:
#   factory-method-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   factory-method-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=factory-method-pattern-explained.mp4
OUT_AUDIO=factory-method-pattern-explained.m4a
OUT_SUBS=factory-method-pattern-explained.srt
