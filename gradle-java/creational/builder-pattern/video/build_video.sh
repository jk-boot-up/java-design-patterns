#!/usr/bin/env bash
#
# Builds the Builder pattern teaching video.
#
...
#
# Outputs:
#   builder-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   builder-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=builder-pattern-explained.mp4
OUT_AUDIO=builder-pattern-explained.m4a
OUT_SUBS=builder-pattern-explained.srt
