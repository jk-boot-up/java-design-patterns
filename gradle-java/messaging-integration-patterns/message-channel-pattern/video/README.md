# Message Channel Pattern — Teaching Video

A narrated, slide-based video that teaches Message Channel, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `message-channel-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `message-channel-pattern-explained.m4a` | Audio-only version. |
| `message-channel-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Message Channel | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force message-channel`, then
...
Upload `message-channel-pattern-explained.mp4`, with
