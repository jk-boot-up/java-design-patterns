#!/usr/bin/env bash
#
# Builds the Message Channel pattern teaching video.
#
...
#
# Outputs:
#   message-channel-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   message-channel-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=message-channel-pattern-explained.mp4
OUT_AUDIO=message-channel-pattern-explained.m4a
OUT_SUBS=message-channel-pattern-explained.srt
