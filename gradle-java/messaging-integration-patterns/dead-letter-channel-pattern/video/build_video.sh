#!/usr/bin/env bash
#
# Builds the Dead Letter Channel pattern teaching video.
#
...
#
# Outputs:
#   dead-letter-channel-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   dead-letter-channel-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=dead-letter-channel-pattern-explained.mp4
OUT_AUDIO=dead-letter-channel-pattern-explained.m4a
OUT_SUBS=dead-letter-channel-pattern-explained.srt
