#!/usr/bin/env bash
#
# Builds the Content-Based Router pattern teaching video.
#
...
#
# Outputs:
#   content-based-router-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   content-based-router-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=content-based-router-pattern-explained.mp4
OUT_AUDIO=content-based-router-pattern-explained.m4a
OUT_SUBS=content-based-router-pattern-explained.srt
