#!/usr/bin/env bash
#
# Builds the Splitter and Aggregator pattern teaching video.
#
...
#
# Outputs:
#   splitter-aggregator-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   splitter-aggregator-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=splitter-aggregator-pattern-explained.mp4
OUT_AUDIO=splitter-aggregator-pattern-explained.m4a
OUT_SUBS=splitter-aggregator-pattern-explained.srt
