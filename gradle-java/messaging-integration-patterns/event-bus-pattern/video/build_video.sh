#!/usr/bin/env bash
#
# Builds the Event Bus pattern teaching video.
#
...
#
# Outputs:
#   event-bus-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   event-bus-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=event-bus-pattern-explained.mp4
OUT_AUDIO=event-bus-pattern-explained.m4a
OUT_SUBS=event-bus-pattern-explained.srt
