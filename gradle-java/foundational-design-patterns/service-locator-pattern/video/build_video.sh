#!/usr/bin/env bash
#
# Builds the Service Locator pattern teaching video.
#
...
#
# Outputs:
#   service-locator-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   service-locator-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=service-locator-pattern-explained.mp4
OUT_AUDIO=service-locator-pattern-explained.m4a
OUT_SUBS=service-locator-pattern-explained.srt
