#!/usr/bin/env bash
#
# Builds the Service Locator with Consul pattern teaching video.
#
...
#
# Outputs:
#   service-locator-with-consul-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   service-locator-with-consul-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=service-locator-with-consul-pattern-explained.mp4
OUT_AUDIO=service-locator-with-consul-pattern-explained.m4a
OUT_SUBS=service-locator-with-consul-pattern-explained.srt
