#!/usr/bin/env bash
#
# Builds the Dependency Injection with Spring pattern teaching video.
#
...
#
# Outputs:
#   dependency-injection-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   dependency-injection-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=dependency-injection-with-spring-pattern-explained.mp4
OUT_AUDIO=dependency-injection-with-spring-pattern-explained.m4a
OUT_SUBS=dependency-injection-with-spring-pattern-explained.srt
