#!/usr/bin/env bash
#
# Builds the Registry with Spring pattern teaching video.
#
...
#
# Outputs:
#   registry-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   registry-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=registry-with-spring-pattern-explained.mp4
OUT_AUDIO=registry-with-spring-pattern-explained.m4a
OUT_SUBS=registry-with-spring-pattern-explained.srt
