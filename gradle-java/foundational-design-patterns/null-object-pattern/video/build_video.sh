#!/usr/bin/env bash
#
# Builds the Null Object pattern teaching video.
#
...
#
# Outputs:
#   null-object-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   null-object-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=null-object-pattern-explained.mp4
OUT_AUDIO=null-object-pattern-explained.m4a
OUT_SUBS=null-object-pattern-explained.srt
