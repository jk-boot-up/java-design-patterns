#!/usr/bin/env bash
#
# Builds the Fluent Interface pattern teaching video.
#
...
#
# Outputs:
#   fluent-interface-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   fluent-interface-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=fluent-interface-pattern-explained.mp4
OUT_AUDIO=fluent-interface-pattern-explained.m4a
OUT_SUBS=fluent-interface-pattern-explained.srt
