#!/usr/bin/env bash
#
# Builds the Dependency Injection pattern teaching video.
#
...
#
# Outputs:
#   dependency-injection-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   dependency-injection-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=dependency-injection-pattern-explained.mp4
OUT_AUDIO=dependency-injection-pattern-explained.m4a
OUT_SUBS=dependency-injection-pattern-explained.srt
