#!/usr/bin/env bash
#
# Builds the Registry pattern teaching video.
#
...
#
# Outputs:
#   registry-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   registry-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=registry-pattern-explained.mp4
OUT_AUDIO=registry-pattern-explained.m4a
OUT_SUBS=registry-pattern-explained.srt
