#!/usr/bin/env bash
#
# Builds the Callback pattern teaching video.
#
...
#
# Outputs:
#   callback-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   callback-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=callback-pattern-explained.mp4
OUT_AUDIO=callback-pattern-explained.m4a
OUT_SUBS=callback-pattern-explained.srt
