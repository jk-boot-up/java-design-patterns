# Execute Around Pattern — Teaching Video

A narrated, slide-based video that teaches Execute Around, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `execute-around-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `execute-around-pattern-explained.m4a` | Audio-only version. |
| `execute-around-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Execute Around | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force execute-around`, then
...
Upload `execute-around-pattern-explained.mp4`, with
