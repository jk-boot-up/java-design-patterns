#!/usr/bin/env bash
#
# Builds the Delegation pattern teaching video.
#
...
#
# Outputs:
#   delegation-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   delegation-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=delegation-pattern-explained.mp4
OUT_AUDIO=delegation-pattern-explained.m4a
OUT_SUBS=delegation-pattern-explained.srt
