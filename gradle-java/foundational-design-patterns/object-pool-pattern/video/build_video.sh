#!/usr/bin/env bash
#
# Builds the Object Pool pattern teaching video.
#
...
#
# Outputs:
#   object-pool-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   object-pool-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=object-pool-pattern-explained.mp4
OUT_AUDIO=object-pool-pattern-explained.m4a
OUT_SUBS=object-pool-pattern-explained.srt
