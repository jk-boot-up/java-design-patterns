#!/usr/bin/env bash
#
# Builds the Object Pool with HikariCP pattern teaching video.
#
...
#
# Outputs:
#   object-pool-with-hikaricp-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   object-pool-with-hikaricp-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=object-pool-with-hikaricp-pattern-explained.mp4
OUT_AUDIO=object-pool-with-hikaricp-pattern-explained.m4a
OUT_SUBS=object-pool-with-hikaricp-pattern-explained.srt
