#!/usr/bin/env python3
"""Render one 1920x1080 PNG slide per scene for the Type Object video."""
...
def footer(d, label):
    ...
    d.text((W - 70, H - 58), "Type Object  ·  Java 21",
...
def kind_poster(scene, img, d):
    ...
    # A class per kind versus a type as data -- both real lines from the project.
    pill(d, 150, 556, 700, 170, RED, "a class for each kind",
         "gift card: a new release", tag="NEW CLASS")
    pill(d, 1070, 556, 700, 170, GREEN, "one Product, a type object",
         "gift card: a new object", tag="NEW DATA")
    ...
    d.text((W // 2, 744), "The kind is data.",
           font=f(SANS_B, 44), fill=TEXT, anchor="ma")
    d.text((W // 2, 796), "A new kind is a new object.",
