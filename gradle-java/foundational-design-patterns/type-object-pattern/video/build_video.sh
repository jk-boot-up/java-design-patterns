#!/usr/bin/env bash
#
# Builds the Type Object pattern teaching video.
#
...
#
# Outputs:
#   type-object-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   type-object-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=type-object-pattern-explained.mp4
OUT_AUDIO=type-object-pattern-explained.m4a
OUT_SUBS=type-object-pattern-explained.srt
