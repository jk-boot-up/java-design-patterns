# Type Object Pattern — Teaching Video

A narrated, slide-based video that teaches Type Object, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `type-object-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `type-object-pattern-explained.m4a` | Audio-only version. |
| `type-object-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Type Object | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force type-object`, then
...
Upload `type-object-pattern-explained.mp4`, with
