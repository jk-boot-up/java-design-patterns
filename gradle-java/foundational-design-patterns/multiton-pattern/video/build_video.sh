#!/usr/bin/env bash
#
# Builds the Multiton pattern teaching video.
#
...
#
# Outputs:
#   multiton-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   multiton-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=multiton-pattern-explained.mp4
OUT_AUDIO=multiton-pattern-explained.m4a
OUT_SUBS=multiton-pattern-explained.srt
