# Multiton Pattern — Teaching Video

A narrated, slide-based video that teaches Multiton, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `multiton-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `multiton-pattern-explained.m4a` | Audio-only version. |
| `multiton-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Multiton | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force multiton`, then
...
Upload `multiton-pattern-explained.mp4`, with
