#!/usr/bin/env bash
#
# Builds the Specification pattern teaching video.
#
...
#
# Outputs:
#   specification-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   specification-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=specification-pattern-explained.mp4
OUT_AUDIO=specification-pattern-explained.m4a
OUT_SUBS=specification-pattern-explained.srt
