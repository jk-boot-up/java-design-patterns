# Specification Pattern — Teaching Video

A narrated, slide-based video that teaches Specification, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `specification-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `specification-pattern-explained.m4a` | Audio-only version. |
| `specification-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Specification | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force specification`, then
...
Upload `specification-pattern-explained.mp4`, with
