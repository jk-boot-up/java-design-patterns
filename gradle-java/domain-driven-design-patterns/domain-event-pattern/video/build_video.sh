#!/usr/bin/env bash
#
# Builds the Domain Event pattern teaching video.
#
...
#
# Outputs:
#   domain-event-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   domain-event-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=domain-event-pattern-explained.mp4
OUT_AUDIO=domain-event-pattern-explained.m4a
OUT_SUBS=domain-event-pattern-explained.srt
