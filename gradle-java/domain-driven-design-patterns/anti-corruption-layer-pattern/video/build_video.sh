#!/usr/bin/env bash
#
# Builds the Anti-Corruption Layer pattern teaching video.
#
...
#
# Outputs:
#   anti-corruption-layer-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   anti-corruption-layer-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=anti-corruption-layer-pattern-explained.mp4
OUT_AUDIO=anti-corruption-layer-pattern-explained.m4a
OUT_SUBS=anti-corruption-layer-pattern-explained.srt
