#!/usr/bin/env bash
#
# Builds the Value Object pattern teaching video.
#
...
#
# Outputs:
#   value-object-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   value-object-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=value-object-pattern-explained.mp4
OUT_AUDIO=value-object-pattern-explained.m4a
OUT_SUBS=value-object-pattern-explained.srt
