#!/usr/bin/env bash
#
# Builds the Aggregate pattern teaching video.
#
...
#
# Outputs:
#   aggregate-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   aggregate-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=aggregate-pattern-explained.mp4
OUT_AUDIO=aggregate-pattern-explained.m4a
OUT_SUBS=aggregate-pattern-explained.srt
