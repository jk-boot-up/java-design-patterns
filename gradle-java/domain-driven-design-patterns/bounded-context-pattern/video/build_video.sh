#!/usr/bin/env bash
#
# Builds the Bounded Context pattern teaching video.
#
...
#
# Outputs:
#   bounded-context-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   bounded-context-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=bounded-context-pattern-explained.mp4
OUT_AUDIO=bounded-context-pattern-explained.m4a
OUT_SUBS=bounded-context-pattern-explained.srt
