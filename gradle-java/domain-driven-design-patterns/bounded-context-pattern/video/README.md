# Bounded Context Pattern — Teaching Video

A narrated, slide-based video that teaches Bounded Context, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `bounded-context-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `bounded-context-pattern-explained.m4a` | Audio-only version. |
| `bounded-context-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Bounded Context | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force bounded-context`, then
...
Upload `bounded-context-pattern-explained.mp4`, with
