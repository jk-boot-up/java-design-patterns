#!/usr/bin/env bash
#
# Builds the Timeout pattern teaching video.
#
...
#
# Outputs:
#   timeout-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   timeout-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=timeout-pattern-explained.mp4
OUT_AUDIO=timeout-pattern-explained.m4a
OUT_SUBS=timeout-pattern-explained.srt
