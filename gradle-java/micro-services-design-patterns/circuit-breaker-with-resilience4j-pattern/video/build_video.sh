#!/usr/bin/env bash
#
# Builds the Circuit Breaker with Resilience4j pattern teaching video.
#
...
#
# Outputs:
#   circuit-breaker-with-resilience4j-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   circuit-breaker-with-resilience4j-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=circuit-breaker-with-resilience4j-pattern-explained.mp4
OUT_AUDIO=circuit-breaker-with-resilience4j-pattern-explained.m4a
OUT_SUBS=circuit-breaker-with-resilience4j-pattern-explained.srt
