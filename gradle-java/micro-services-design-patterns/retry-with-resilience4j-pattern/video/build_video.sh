#!/usr/bin/env bash
#
# Builds the Retry with Resilience4j pattern teaching video.
#
...
#
# Outputs:
#   retry-with-resilience4j-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   retry-with-resilience4j-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=retry-with-resilience4j-pattern-explained.mp4
OUT_AUDIO=retry-with-resilience4j-pattern-explained.m4a
OUT_SUBS=retry-with-resilience4j-pattern-explained.srt
