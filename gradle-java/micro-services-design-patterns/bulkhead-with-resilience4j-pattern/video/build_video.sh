#!/usr/bin/env bash
#
# Builds the Bulkhead with Resilience4j pattern teaching video.
#
...
#
# Outputs:
#   bulkhead-with-resilience4j-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   bulkhead-with-resilience4j-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=bulkhead-with-resilience4j-pattern-explained.mp4
OUT_AUDIO=bulkhead-with-resilience4j-pattern-explained.m4a
OUT_SUBS=bulkhead-with-resilience4j-pattern-explained.srt
