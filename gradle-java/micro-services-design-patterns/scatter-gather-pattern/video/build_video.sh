#!/usr/bin/env bash
#
# Builds the Scatter-Gather pattern teaching video.
#
...
#
# Outputs:
#   scatter-gather-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   scatter-gather-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=scatter-gather-pattern-explained.mp4
OUT_AUDIO=scatter-gather-pattern-explained.m4a
OUT_SUBS=scatter-gather-pattern-explained.srt
