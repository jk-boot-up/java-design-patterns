# Scatter-Gather Pattern — Teaching Video

A narrated, slide-based video that teaches Scatter-Gather, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `scatter-gather-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `scatter-gather-pattern-explained.m4a` | Audio-only version. |
| `scatter-gather-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Scatter-Gather | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force scatter-gather`, then
...
Upload `scatter-gather-pattern-explained.mp4`, with
