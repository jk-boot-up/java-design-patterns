...
#
# Outputs:
#   idempotent-consumer-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   idempotent-consumer-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=idempotent-consumer-pattern-explained.mp4
OUT_AUDIO=idempotent-consumer-pattern-explained.m4a
OUT_SUBS=idempotent-consumer-pattern-explained.srt
