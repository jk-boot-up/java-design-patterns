...
#   circuit-breaker-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=circuit-breaker-pattern-explained.mp4
OUT_AUDIO=circuit-breaker-pattern-explained.m4a
OUT_SUBS=circuit-breaker-pattern-explained.srt
