...
#   api-composition-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=api-composition-pattern-explained.mp4
OUT_AUDIO=api-composition-pattern-explained.m4a
OUT_SUBS=api-composition-pattern-explained.srt
