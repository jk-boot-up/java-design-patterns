# Competing Consumers Pattern — Teaching Video

A narrated, slide-based video that teaches Competing Consumers, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `competing-consumers-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `competing-consumers-pattern-explained.m4a` | Audio-only version. |
| `competing-consumers-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Competing Consumers | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force competing-consumers`, then
...
Upload `competing-consumers-pattern-explained.mp4`, with
