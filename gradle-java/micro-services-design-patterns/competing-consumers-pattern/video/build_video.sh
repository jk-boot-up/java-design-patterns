#!/usr/bin/env bash
#
# Builds the Competing Consumers pattern teaching video.
#
...
#
# Outputs:
#   competing-consumers-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   competing-consumers-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=competing-consumers-pattern-explained.mp4
OUT_AUDIO=competing-consumers-pattern-explained.m4a
OUT_SUBS=competing-consumers-pattern-explained.srt
