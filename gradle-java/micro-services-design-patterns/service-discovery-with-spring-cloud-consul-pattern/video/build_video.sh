#!/usr/bin/env bash
#
# Builds the Service Discovery with Spring Cloud Consul pattern teaching video.
#
...
#
# Outputs:
#   service-discovery-with-spring-cloud-consul-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   service-discovery-with-spring-cloud-consul-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=service-discovery-with-spring-cloud-consul-pattern-explained.mp4
OUT_AUDIO=service-discovery-with-spring-cloud-consul-pattern-explained.m4a
OUT_SUBS=service-discovery-with-spring-cloud-consul-pattern-explained.srt
