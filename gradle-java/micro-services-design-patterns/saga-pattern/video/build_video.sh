...
#
# Outputs:
#   saga-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   saga-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=saga-pattern-explained.mp4
OUT_AUDIO=saga-pattern-explained.m4a
OUT_SUBS=saga-pattern-explained.srt
