#!/usr/bin/env bash
#
# Builds the Load Balancing with Spring Cloud LoadBalancer pattern teaching video.
#
...
#
# Outputs:
#   load-balancing-with-spring-cloud-loadbalancer-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   load-balancing-with-spring-cloud-loadbalancer-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=load-balancing-with-spring-cloud-loadbalancer-pattern-explained.mp4
OUT_AUDIO=load-balancing-with-spring-cloud-loadbalancer-pattern-explained.m4a
OUT_SUBS=load-balancing-with-spring-cloud-loadbalancer-pattern-explained.srt
