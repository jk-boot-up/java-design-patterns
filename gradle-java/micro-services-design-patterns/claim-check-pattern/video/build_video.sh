#!/usr/bin/env bash
#
# Builds the Claim Check pattern teaching video.
#
...
#
# Outputs:
#   claim-check-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   claim-check-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=claim-check-pattern-explained.mp4
OUT_AUDIO=claim-check-pattern-explained.m4a
OUT_SUBS=claim-check-pattern-explained.srt
