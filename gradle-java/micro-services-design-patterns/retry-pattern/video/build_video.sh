#!/usr/bin/env bash
#
# Builds the Retry with Backoff teaching video.
#
...
#
# Outputs:
#   retry-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   retry-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=retry-pattern-explained.mp4
OUT_AUDIO=retry-pattern-explained.m4a
OUT_SUBS=retry-pattern-explained.srt
