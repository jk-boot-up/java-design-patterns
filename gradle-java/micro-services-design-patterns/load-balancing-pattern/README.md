...
[Load Balancing with Spring Cloud LoadBalancer Pattern](../load-balancing-with-spring-cloud-loadbalancer-pattern) reruns this idea on a real framework, and shows what the framework adds and where it can undo the pattern. Watch this project first.
