#!/usr/bin/env bash
#
# Builds the Client-Side Load Balancing teaching video.
#
...
#
# Outputs:
#   load-balancing-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   load-balancing-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=load-balancing-pattern-explained.mp4
OUT_AUDIO=load-balancing-pattern-explained.m4a
OUT_SUBS=load-balancing-pattern-explained.srt
