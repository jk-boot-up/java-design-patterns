#!/usr/bin/env bash
#
# Builds the Queue-Based Load Leveling pattern teaching video.
#
...
#
# Outputs:
#   queue-based-load-leveling-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   queue-based-load-leveling-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=queue-based-load-leveling-pattern-explained.mp4
OUT_AUDIO=queue-based-load-leveling-pattern-explained.m4a
OUT_SUBS=queue-based-load-leveling-pattern-explained.srt
