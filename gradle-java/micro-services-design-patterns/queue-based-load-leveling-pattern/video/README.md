# Queue-Based Load Leveling Pattern — Teaching Video

A narrated, slide-based video that teaches Queue-Based Load Leveling, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `queue-based-load-leveling-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `queue-based-load-leveling-pattern-explained.m4a` | Audio-only version. |
| `queue-based-load-leveling-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Queue-Based Load Leveling | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force queue-based-load-leveling`, then
...
Upload `queue-based-load-leveling-pattern-explained.mp4`, with
