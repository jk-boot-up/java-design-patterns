#!/usr/bin/env python3
"""Render one 1920x1080 PNG slide per scene for the Queue-Based Load Leveling video."""
...
def footer(d, label):
    ...
    d.text((W - 70, H - 58), "Queue-Based Load Leveling  ·  Java 21",
...
def kind_poster(scene, img, d):
    ...
    fitted("LOAD LEVELING", 152, TEXT)
    fitted("A QUEUE IN BETWEEN", 288, ACCENT)
    ...
    # A burst refused versus queued -- both real lines from the project.
    pill(d, 150, 556, 700, 170, RED, "100 at once, no queue",
         "90 refused", tag="REFUSED")
    pill(d, 1070, 556, 700, 170, GREEN, "100 at once, a queue",
         "100 processed, 0 refused", tag="LEVELED")
    ...
    d.text((W // 2, 744), "The burst waits its turn.",
           font=f(SANS_B, 44), fill=TEXT, anchor="ma")
    d.text((W // 2, 796), "The worker keeps its pace.",
