#!/usr/bin/env bash
#
# Builds the Strategy pattern teaching video.
#
...
#
# Outputs:
#   transactional-outbox-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   transactional-outbox-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=transactional-outbox-pattern-explained.mp4
OUT_AUDIO=transactional-outbox-pattern-explained.m4a
OUT_SUBS=transactional-outbox-pattern-explained.srt
