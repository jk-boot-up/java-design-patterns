...
[Bulkhead with Resilience4j Pattern](../bulkhead-with-resilience4j-pattern) reruns this idea on a real framework, and shows what the framework adds and where it can undo the pattern. Watch this project first.
