...
#   bulkhead-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=bulkhead-pattern-explained.mp4
OUT_AUDIO=bulkhead-pattern-explained.m4a
OUT_SUBS=bulkhead-pattern-explained.srt
