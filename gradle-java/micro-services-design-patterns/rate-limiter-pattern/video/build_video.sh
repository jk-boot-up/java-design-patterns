#!/usr/bin/env bash
#
# Builds the Rate Limiter pattern teaching video.
#
...
#
# Outputs:
#   rate-limiter-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   rate-limiter-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=rate-limiter-pattern-explained.mp4
OUT_AUDIO=rate-limiter-pattern-explained.m4a
OUT_SUBS=rate-limiter-pattern-explained.srt
