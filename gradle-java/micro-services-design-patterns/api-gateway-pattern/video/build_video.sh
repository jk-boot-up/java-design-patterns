#!/usr/bin/env bash
#
# Builds the API Gateway pattern teaching video.
#
...
#
# Outputs:
#   api-gateway-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   api-gateway-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=api-gateway-pattern-explained.mp4
OUT_AUDIO=api-gateway-pattern-explained.m4a
OUT_SUBS=api-gateway-pattern-explained.srt
