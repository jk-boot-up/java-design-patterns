#!/usr/bin/env bash
#
# Builds the Leader Election pattern teaching video.
#
...
#
# Outputs:
#   leader-election-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   leader-election-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=leader-election-pattern-explained.mp4
OUT_AUDIO=leader-election-pattern-explained.m4a
OUT_SUBS=leader-election-pattern-explained.srt
