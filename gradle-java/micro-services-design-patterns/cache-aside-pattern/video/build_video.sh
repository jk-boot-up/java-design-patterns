#!/usr/bin/env bash
#
# Builds the Cache-Aside pattern teaching video.
#
...
#
# Outputs:
#   cache-aside-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   cache-aside-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=cache-aside-pattern-explained.mp4
OUT_AUDIO=cache-aside-pattern-explained.m4a
OUT_SUBS=cache-aside-pattern-explained.srt
