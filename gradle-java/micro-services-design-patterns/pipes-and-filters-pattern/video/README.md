# Pipes and Filters Pattern — Teaching Video

A narrated, slide-based video that teaches Pipes and Filters, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `pipes-and-filters-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `pipes-and-filters-pattern-explained.m4a` | Audio-only version. |
| `pipes-and-filters-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Pipes and Filters | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force pipes-and-filters`, then
...
Upload `pipes-and-filters-pattern-explained.mp4`, with
