#!/usr/bin/env bash
#
# Builds the Pipes and Filters pattern teaching video.
#
...
#
# Outputs:
#   pipes-and-filters-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   pipes-and-filters-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=pipes-and-filters-pattern-explained.mp4
OUT_AUDIO=pipes-and-filters-pattern-explained.m4a
OUT_SUBS=pipes-and-filters-pattern-explained.srt
