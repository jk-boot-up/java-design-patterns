#!/usr/bin/env bash
#
# Builds the API Gateway with Spring Cloud Gateway pattern teaching video.
#
...
#
# Outputs:
#   api-gateway-with-spring-cloud-gateway-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   api-gateway-with-spring-cloud-gateway-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=api-gateway-with-spring-cloud-gateway-pattern-explained.mp4
OUT_AUDIO=api-gateway-with-spring-cloud-gateway-pattern-explained.m4a
OUT_SUBS=api-gateway-with-spring-cloud-gateway-pattern-explained.srt
