#!/usr/bin/env bash
#
# Builds the Publisher-Subscriber pattern teaching video.
#
...
#
# Outputs:
#   publisher-subscriber-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   publisher-subscriber-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=publisher-subscriber-pattern-explained.mp4
OUT_AUDIO=publisher-subscriber-pattern-explained.m4a
OUT_SUBS=publisher-subscriber-pattern-explained.srt
