# Publisher-Subscriber Pattern — Teaching Video

A narrated, slide-based video that teaches Publisher-Subscriber, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `publisher-subscriber-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `publisher-subscriber-pattern-explained.m4a` | Audio-only version. |
| `publisher-subscriber-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Publisher-Subscriber | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force publisher-subscriber`, then
...
Upload `publisher-subscriber-pattern-explained.mp4`, with
