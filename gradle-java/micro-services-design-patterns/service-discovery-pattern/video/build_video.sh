...
#
# Outputs:
#   service-discovery-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   service-discovery-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=service-discovery-pattern-explained.mp4
OUT_AUDIO=service-discovery-pattern-explained.m4a
OUT_SUBS=service-discovery-pattern-explained.srt
