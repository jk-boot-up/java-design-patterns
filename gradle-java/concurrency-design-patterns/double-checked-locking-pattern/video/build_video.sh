#!/usr/bin/env bash
#
# Builds the Double-Checked Locking pattern teaching video.
#
...
#
# Outputs:
#   double-checked-locking-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   double-checked-locking-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=double-checked-locking-pattern-explained.mp4
OUT_AUDIO=double-checked-locking-pattern-explained.m4a
OUT_SUBS=double-checked-locking-pattern-explained.srt
