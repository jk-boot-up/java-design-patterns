#!/usr/bin/env bash
#
# Builds the Actor pattern teaching video.
#
...
#
# Outputs:
#   actor-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   actor-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=actor-pattern-explained.mp4
OUT_AUDIO=actor-pattern-explained.m4a
OUT_SUBS=actor-pattern-explained.srt
