# Actor Pattern — Teaching Video

A narrated, slide-based video that teaches Actor, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `actor-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `actor-pattern-explained.m4a` | Audio-only version. |
| `actor-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Actor | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force actor`, then
...
Upload `actor-pattern-explained.mp4`, with
