#!/usr/bin/env bash
#
# Builds the Active Object pattern teaching video.
#
...
#
# Outputs:
#   active-object-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   active-object-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=active-object-pattern-explained.mp4
OUT_AUDIO=active-object-pattern-explained.m4a
OUT_SUBS=active-object-pattern-explained.srt
