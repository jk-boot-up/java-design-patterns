#!/usr/bin/env bash
#
# Builds the Future-Promise pattern teaching video.
#
...
#
# Outputs:
#   future-promise-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   future-promise-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=future-promise-pattern-explained.mp4
OUT_AUDIO=future-promise-pattern-explained.m4a
OUT_SUBS=future-promise-pattern-explained.srt
