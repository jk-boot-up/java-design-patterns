#!/usr/bin/env bash
#
# Builds the Read-Write Lock pattern teaching video.
#
...
#
# Outputs:
#   read-write-lock-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   read-write-lock-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=read-write-lock-pattern-explained.mp4
OUT_AUDIO=read-write-lock-pattern-explained.m4a
OUT_SUBS=read-write-lock-pattern-explained.srt
