#!/usr/bin/env bash
#
# Builds the Guarded Suspension pattern teaching video.
#
...
#
# Outputs:
#   guarded-suspension-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   guarded-suspension-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=guarded-suspension-pattern-explained.mp4
OUT_AUDIO=guarded-suspension-pattern-explained.m4a
OUT_SUBS=guarded-suspension-pattern-explained.srt
