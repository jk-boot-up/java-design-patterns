#!/usr/bin/env bash
#
# Builds the Two-Phase Termination pattern teaching video.
#
...
#
# Outputs:
#   two-phase-termination-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   two-phase-termination-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=two-phase-termination-pattern-explained.mp4
OUT_AUDIO=two-phase-termination-pattern-explained.m4a
OUT_SUBS=two-phase-termination-pattern-explained.srt
