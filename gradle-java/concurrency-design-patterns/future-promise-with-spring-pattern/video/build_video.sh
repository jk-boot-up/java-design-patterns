#!/usr/bin/env bash
#
# Builds the Future/Promise with Spring pattern teaching video.
#
...
#
# Outputs:
#   future-promise-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   future-promise-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=future-promise-with-spring-pattern-explained.mp4
OUT_AUDIO=future-promise-with-spring-pattern-explained.m4a
OUT_SUBS=future-promise-with-spring-pattern-explained.srt
