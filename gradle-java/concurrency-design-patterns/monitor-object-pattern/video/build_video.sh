#!/usr/bin/env bash
#
# Builds the Monitor Object pattern teaching video.
#
...
#
# Outputs:
#   monitor-object-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   monitor-object-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=monitor-object-pattern-explained.mp4
OUT_AUDIO=monitor-object-pattern-explained.m4a
OUT_SUBS=monitor-object-pattern-explained.srt
