#!/usr/bin/env bash
#
# Builds the Producer-Consumer pattern teaching video.
#
...
#
# Outputs:
#   producer-consumer-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   producer-consumer-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=producer-consumer-pattern-explained.mp4
OUT_AUDIO=producer-consumer-pattern-explained.m4a
OUT_SUBS=producer-consumer-pattern-explained.srt
