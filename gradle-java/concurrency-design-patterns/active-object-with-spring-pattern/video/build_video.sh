#!/usr/bin/env bash
#
# Builds the Active Object with Spring pattern teaching video.
#
...
#
# Outputs:
#   active-object-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   active-object-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=active-object-with-spring-pattern-explained.mp4
OUT_AUDIO=active-object-with-spring-pattern-explained.m4a
OUT_SUBS=active-object-with-spring-pattern-explained.srt
