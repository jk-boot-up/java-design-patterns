#!/usr/bin/env bash
#
# Builds the Thread Pool pattern teaching video.
#
...
#
# Outputs:
#   thread-pool-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   thread-pool-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=thread-pool-pattern-explained.mp4
OUT_AUDIO=thread-pool-pattern-explained.m4a
OUT_SUBS=thread-pool-pattern-explained.srt
