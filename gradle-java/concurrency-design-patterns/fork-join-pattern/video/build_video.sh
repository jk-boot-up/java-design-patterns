#!/usr/bin/env bash
#
# Builds the Fork-Join pattern teaching video.
#
...
#
# Outputs:
#   fork-join-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   fork-join-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=fork-join-pattern-explained.mp4
OUT_AUDIO=fork-join-pattern-explained.m4a
OUT_SUBS=fork-join-pattern-explained.srt
