#!/usr/bin/env bash
#
# Builds the Balking pattern teaching video.
#
...
#
# Outputs:
#   balking-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   balking-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=balking-pattern-explained.mp4
OUT_AUDIO=balking-pattern-explained.m4a
OUT_SUBS=balking-pattern-explained.srt
