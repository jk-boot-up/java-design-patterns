# Balking Pattern — Teaching Video

A narrated, slide-based video that teaches Balking, and argues for when not to use it,
...
| File | What it is |
| --- | --- |
| `balking-pattern-explained.mp4` | The video — 1920×1080, H.264, 30 fps, stereo AAC. |
| `balking-pattern-explained.m4a` | Audio-only version. |
| `balking-pattern-explained.srt` | Subtitles. |
...
| # | Scene | Covers |
| --- | --- | --- |
| 1 | Balking | Title card and the definition |
...
`python3 ../../docs/make_narration.py --force balking`, then
...
Upload `balking-pattern-explained.mp4`, with
