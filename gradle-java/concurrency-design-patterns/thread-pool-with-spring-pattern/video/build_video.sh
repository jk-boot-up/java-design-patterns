#!/usr/bin/env bash
#
# Builds the Thread Pool with Spring pattern teaching video.
#
...
#
# Outputs:
#   thread-pool-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   thread-pool-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=thread-pool-with-spring-pattern-explained.mp4
OUT_AUDIO=thread-pool-with-spring-pattern-explained.m4a
OUT_SUBS=thread-pool-with-spring-pattern-explained.srt
