#!/usr/bin/env bash
#
# Builds the Template Method with Spring pattern teaching video.
#
...
#
# Outputs:
#   template-method-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   template-method-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=template-method-with-spring-pattern-explained.mp4
OUT_AUDIO=template-method-with-spring-pattern-explained.m4a
OUT_SUBS=template-method-with-spring-pattern-explained.srt
