#!/usr/bin/env bash
#
# Builds the Chain of Responsibility with Spring pattern teaching video.
#
...
#
# Outputs:
#   chain-of-responsibility-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   chain-of-responsibility-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=chain-of-responsibility-with-spring-pattern-explained.mp4
OUT_AUDIO=chain-of-responsibility-with-spring-pattern-explained.m4a
OUT_SUBS=chain-of-responsibility-with-spring-pattern-explained.srt
