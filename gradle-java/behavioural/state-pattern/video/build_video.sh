#!/usr/bin/env bash
#
# Builds the State pattern teaching video.
#
...
#
# Outputs:
#   state-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   state-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=state-pattern-explained.mp4
OUT_AUDIO=state-pattern-explained.m4a
OUT_SUBS=state-pattern-explained.srt
