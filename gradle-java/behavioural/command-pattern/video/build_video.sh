...
#
# Outputs:
#   command-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   command-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=command-pattern-explained.mp4
OUT_AUDIO=command-pattern-explained.m4a
OUT_SUBS=command-pattern-explained.srt
