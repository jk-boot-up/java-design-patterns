#!/usr/bin/env bash
#
# Builds the Visitor pattern teaching video.
#
...
#
# Outputs:
#   visitor-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   visitor-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=visitor-pattern-explained.mp4
OUT_AUDIO=visitor-pattern-explained.m4a
OUT_SUBS=visitor-pattern-explained.srt
