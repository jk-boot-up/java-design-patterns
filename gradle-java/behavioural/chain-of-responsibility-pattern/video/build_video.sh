#!/usr/bin/env bash
#
# Builds the Chain of Responsibility pattern teaching video.
#
...
#
# Outputs:
#   chain-of-responsibility-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   chain-of-responsibility-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=chain-of-responsibility-pattern-explained.mp4
OUT_AUDIO=chain-of-responsibility-pattern-explained.m4a
OUT_SUBS=chain-of-responsibility-pattern-explained.srt
