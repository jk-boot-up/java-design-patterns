#!/usr/bin/env bash
#
# Builds the Observer with Spring pattern teaching video.
#
...
#
# Outputs:
#   observer-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   observer-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=observer-with-spring-pattern-explained.mp4
OUT_AUDIO=observer-with-spring-pattern-explained.m4a
OUT_SUBS=observer-with-spring-pattern-explained.srt
