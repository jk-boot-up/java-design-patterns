#!/usr/bin/env bash
#
# Builds the Interpreter with SpEL pattern teaching video.
#
...
#
# Outputs:
#   interpreter-with-spel-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   interpreter-with-spel-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=interpreter-with-spel-pattern-explained.mp4
OUT_AUDIO=interpreter-with-spel-pattern-explained.m4a
OUT_SUBS=interpreter-with-spel-pattern-explained.srt
