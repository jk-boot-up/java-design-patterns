#!/usr/bin/env bash
#
# Builds the Observer pattern teaching video.
#
...
#
# Outputs:
#   observer-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   observer-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=observer-pattern-explained.mp4
OUT_AUDIO=observer-pattern-explained.m4a
OUT_SUBS=observer-pattern-explained.srt
