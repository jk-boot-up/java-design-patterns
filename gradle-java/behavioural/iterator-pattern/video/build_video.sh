#!/usr/bin/env bash
#
# Builds the Iterator pattern teaching video.
#
...
#
# Outputs:
#   iterator-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   iterator-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=iterator-pattern-explained.mp4
OUT_AUDIO=iterator-pattern-explained.m4a
OUT_SUBS=iterator-pattern-explained.srt
