#!/usr/bin/env bash
#
# Builds the Memento pattern teaching video.
#
...
#
# Outputs:
#   memento-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   memento-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=memento-pattern-explained.mp4
OUT_AUDIO=memento-pattern-explained.m4a
OUT_SUBS=memento-pattern-explained.srt
