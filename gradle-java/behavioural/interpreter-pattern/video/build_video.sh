#!/usr/bin/env bash
#
# Builds the Interpreter pattern teaching video.
#
...
#
# Outputs:
#   interpreter-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   interpreter-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=interpreter-pattern-explained.mp4
OUT_AUDIO=interpreter-pattern-explained.m4a
OUT_SUBS=interpreter-pattern-explained.srt
