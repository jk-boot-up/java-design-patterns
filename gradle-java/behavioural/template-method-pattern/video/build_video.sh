#!/usr/bin/env bash
#
# Builds the Template Method pattern teaching video.
#
...
#
# Outputs:
#   template-method-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   template-method-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=template-method-pattern-explained.mp4
OUT_AUDIO=template-method-pattern-explained.m4a
OUT_SUBS=template-method-pattern-explained.srt
