#!/usr/bin/env bash
#
# Builds the Mediator pattern teaching video.
#
...
#
# Outputs:
#   mediator-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   mediator-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=mediator-pattern-explained.mp4
OUT_AUDIO=mediator-pattern-explained.m4a
OUT_SUBS=mediator-pattern-explained.srt
