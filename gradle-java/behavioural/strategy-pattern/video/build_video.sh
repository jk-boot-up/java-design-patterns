...
#
# Outputs:
#   strategy-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   strategy-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=strategy-pattern-explained.mp4
OUT_AUDIO=strategy-pattern-explained.m4a
OUT_SUBS=strategy-pattern-explained.srt
