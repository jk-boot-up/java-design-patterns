#!/usr/bin/env bash
#
# Builds the Strategy with Spring pattern teaching video.
#
...
#
# Outputs:
#   strategy-with-spring-pattern-explained.mp4   1080p H.264 + AAC, ready for YouTube
#   strategy-with-spring-pattern-explained.m4a   audio-only version (podcast / revision)
...
OUT_VIDEO=strategy-with-spring-pattern-explained.mp4
OUT_AUDIO=strategy-with-spring-pattern-explained.m4a
OUT_SUBS=strategy-with-spring-pattern-explained.srt
